    ...
    do j=2,ny-1
      do i=2,nx-1
          ...
          if (i==nx-1) then
             ...
             ! me_star(i,j)=me_star(i,j)+rho*0.5_dp*(1.0_dp/ap_u(i,j)&
          ...
          if (i==2) then
             ...
             ! mw_star(i,j)=mw_star(i,j)+rho*0.5_dp*(1.0_dp/ap_u(i,j)&
          ...
          if (j==ny-1) then
             ...
             ! mn_star(i,j)=mn_star(i,j)+rho*0.5_dp*(1.0_dp/ap_v(i,j)&
          ...
          if (j==2) then
             ...
             ! ms_star(i,j)=ms_star(i,j)+rho*0.5_dp*(1.0_dp/ap_v(i,j)&
