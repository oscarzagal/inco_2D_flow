    ...
    do j=2,ny-1
      do i=2,nx-1
         ...
         if (i==nx-1) then
            ...
            ! de_i=0.5_dp*deltay(j)*(1.0_dp/ap_u(i,j)+1.0_dp/ap_u(i+1,j))
         ...
         if (i==2) then
            ...
            ! dw_i=0.5_dp*deltay(j)*(1.0_dp/ap_u(i,j)+1.0_dp/ap_u(i-1,j))
         ...
         if (j==ny-1) then
            ...
            ! dn_i=0.5_dp*deltax(i)*(1.0_dp/ap_v(i,j)+1.0_dp/ap_v(i,j+1))
         ...
         if (j==2) then
            ...
            ! ds_i=0.5_dp*deltax(i)*(1.0_dp/ap_v(i,j)+1.0_dp/ap_v(i,j-1))
         ...
         b_p(i,j)=-(me_star(i,j)+mw_star(i,j)+mn_star(i,j)+ms_star(i,j))/rho
